...
function initWishlist() {
    ...
    console.log(`Wishlist initialized with ${wishlistCount} items`);
}
...
function showCategoryDropdown() {
    const categories = [
        ...
        {
            name: 'Kinder',
            subcategories: ['Baby (0-2)', 'Kleinkind (3-6)', 'Kind (7-12)', 'Teenager (13+)', 'Schuhe', 'Spielzeug']
        },
        {
            name: 'Sonstiges',
            subcategories: ['Ohne Kategorie', 'Neu hochgeladen', 'Vintage', 'Designer']
        }
    ];

    showNotification('Kategorie-Filter wird geöffnet...', 'info');
